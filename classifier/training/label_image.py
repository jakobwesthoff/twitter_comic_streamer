...
if __name__ == '__main__':
  ...
  parser.add_argument(
    '--check_label', default=0, type=int, help='label to warn if found')
  ...
  for filename in os.listdir(args.image):
      try:
          img_orig = Image.open(args.image + "/" + filename).resize((width, height))
